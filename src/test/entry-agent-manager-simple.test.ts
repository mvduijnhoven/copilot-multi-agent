/**
 * Simple standalone tests for EntryAgentManager functionality
 */
...
async function runTests() {
  console.log('Running EntryAgentManager Tests...\n');
  ...
  await test('should fail when no agents configured', async () => {
  ...
  await test('should fail when configuration is null', async () => {
